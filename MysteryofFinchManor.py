...
def monster_encounter():
    ...
    print("The very air around you feels alive, pressing against your chest and pulling at your limbs, urging you to choose before it's too late.")
    options = [
        'Run',
        "Hide",
        "Fight"
    ...
    choice = dialog_options(options)
    if choice == 0:
        print('You spin on your heel, heart hammering in your chest, and bolt down the hallway.\nEach step sends tremors through the pulsating floor, slick with blood and fungus.\nThe servant’s grotesque, disjointed frame skitters after you, his claws raking against the walls and ceiling, spreading his gross disease along the walls. \nAhead, the hallway bends and warps, opening into surreal vistas of past confrontations.\n')
    elif choice == 1:
        print('You dart into a nearby room, the door creaking ominously as you slam it shut it behind you.\nThe room is small and claustrophobic, lit faintly by a pulsating, bioluminescent fungus clinging to the walls.\nA cracked wardrobe leans in the corner, and the faint sound of your own breath is deafening in the stifling air.\nYou press yourself into the shadows, crouching behind an overturned chair, your heart pounding as the grotesque figure approaches.\n')
    elif choice == 2:
        print('Holding your fists up, you face the monstrous servant, your pulse pounding with terror and resolve.\nAs he lunges, you strike, a desperate, wild action that tears into the fleshy growths writhing across his frame. He recoils, emitting a deafening, wet groan, his limbs twitching violently.\nWith a swipe of his blackened claws, he catches your shoulder with sickening precision.\nPain blooms hot and sharp, a blinding agony that floods your senses as blood splatters across the walls.\n The moment your skin rends, you feel something worse… \nFingers, grotesque and malformed, sprout from the wound, writhing and tearing deeper, as if the pain itself is clawing to consume you from the inside.\n')
    return choice
#Benjamin Hall
...
#Occurs when the room is the entrance hall
    ...
    while G.currentRoom == "Guest Bathrooms":
        G.user_input()
        if "back" in G.input or "to library" in G.input:
            G.clear_screen()
            C.tell_commands()
    ...
    while G.currentRoom == "Long Hallway":
        if G.roomEntryCounts ['Long Hallway'] == 1:
            ...
            G.user_input()
            if "examine book" in G.input:
                print("\nThe book is now open to a new page:\n    'Fungus blooms where thought should dwell. Hemlock, the plant of death, sprouts from his ruined skull as if to mock my ambitions. \n   The air rots in his wake, thick with the stench of decay. He drags his twisted claws along the walls, and with each motion, something unspeakable is birthed: \n   masses of limbs, pulsing fungi, blood made flesh. His creations writhe in agony, yet they live. \n   They serve.' - Dr. Finch\n")
            elif "to 1st room" in G.input:
                if G.roomEntryCounts ['Mystery Room'] == 0:
                    G.clear_screen()
                    C.tell_commands()
            ...
            G.clear_screen()
            monster_encounter()
            if monster_encounter() == 0:
                print("\nRunning through the seemingly endless hallway, you get glimpses of visions entailing arguments between Elias and his father.\nYou push through slamming into the door, and when you turn to look behind you the door is gone...\n")
                ...
                G.proceed("Upper Landing")
            elif monster_encounter() == 1:
                print("\nYou can hear the servant clawing at the door until it stops suddenly.\nYou stand shakily and approach the door. \nAs you open it, some force pushes you out and onto the wood floor.\nWhen you stand up, you are in the upper landing, the servant is gone, and the door which should be behind you is too.\n")
                G.add_to_interactions("Journal Chase")
                C.tell_commands()
                G.roomDescribe = "There is a small alcove a short bit down the stairs that branches to more rooms. \nFurther down is the entrance hall. \nAcross the balcony is the door to the master bedroom.\n"
                G.proceed("Upper Landing")
            elif monster_encounter() == 2:
                print("\nWith each blow you trade with the servant, a vision is blasted through your mind of Elias's disagreements with his father.\nAfter one of these visions, you fail to recall which, the servant vanishes.\nYou are no longer in the hallway, but rather the upper landing, and the wall where the door to the hallway used to be is empty.\n")
                G.add_to_interactions("Journal Chase")
                C.tell_commands()
                G.roomDescribe = "There is a small alcove a short bit down the stairs that branches to more rooms. \nFurther down is the entrance hall. \nAcross the balcony is the door to the master bedroom.\n"
                G.proceed("Upper Landing")
